...
/***/ "./src/demos/NewApp/Elements/E1/E1.tsx":
/*!*********************************************!*\
  !*** ./src/demos/NewApp/Elements/E1/E1.tsx ***!
  \*********************************************/
...
class E1 extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  inspector() {
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("h1", null, "aaa");
  }

  render() {
    console.log('props...', this.props); // console.log('inspector...', ElementContainer.inspector())

    const dataE1 = this.props.data;
    const data = this.props.data.state.data; // console.log('data props...', data)
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", _extends({
      ...
      id: 'E1'
    }), react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("h1", null, " E1"), react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", {
      value: dataE1.state.data.text,
      onChange: e => dataE1.setState({
        data: {
          text: e.target.value,
          text2: dataE1.state.data.text2
        }
      })
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_Components_createElement__WEBPACK_IMPORTED_MODULE_1__["createElement"])(E1, new _stores_stores__WEBPACK_IMPORTED_MODULE_2__["ElementContainer"]({
  type: 'E1',
  children: [],
  data: {
    text: '',
